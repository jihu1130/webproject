...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // div.textContent -> innerHTML 왕복만으로는 &/</>는 막아도 "와 '는 안 막힌다(속성값 안에는
    // 텍스트 노드 이스케이프 규칙이 아니라 속성 이스케이프 규칙이 적용되기 때문) - 댓글 수정창처럼
    // value="..." 속성 안에 넣을 때 self-XSS로 이어질 수 있어서 따옴표도 직접 치환해준다.
